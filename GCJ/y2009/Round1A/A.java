 ...
 * Solution: This implementation is ugly. After 1 round the number is < 10000 so
 * just make a table for the low values and then everything can be tested in O(1).
 */
